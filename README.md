...
### 🙋 I want someone else to add it.

If you'd rather not build the scraper yourself, open a request on the project's **[Issues](https://github.com/Moggle-Khraum/NovelDR/issues)** page using this format:

**Title** — the title of your message

**Tag** — choose **Request Source**

**Description** — tell us the novel site to add and any other details we should know beforehand (e.g. site name/URL, whether it needs login, anything unusual about its layout)
