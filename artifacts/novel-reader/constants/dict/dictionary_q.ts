...
export const DICTIONARY_Q: Record<string, DictionaryEntry> = {
  "quack": { meaning: "The sound of a duck; a fraudulent doctor; to make such a sound.", pos: "noun" },
  "quadrant": { meaning: "A quarter of a circle; an instrument for measuring angles.", pos: "noun" },
  ...
  "quadruple": { meaning: "Four times as much; to multiply by four.", pos: "adjective" },
  "quadruplet": { meaning: "One of four offspring born at one birth.", pos: "noun" },
  "quaff": { meaning: "To drink deeply; to swallow.", pos: "verb" },
  "quagmire": { meaning: "A soft boggy area; a difficult situation.", pos: "noun" },
  ...
  "qualification": { meaning: "A requirement; a skill; a modification.", pos: "noun" },
  "qualified": { meaning: "Meeting the requirements; competent.", pos: "adjective" },
  "qualify": { meaning: "To meet requirements; to limit; to modify.", pos: "verb" },
  "quality": { meaning: "A distinctive attribute or level of excellence.", pos: "noun" },
  "qualm": { meaning: "A sudden feeling of uneasiness; a misgiving.", pos: "noun" },
  ...
  "quarrelsome": { meaning: "Argumentative; inclined to quarrel.", pos: "adjective" },
  "quarry": { meaning: "A place where stone is extracted; prey; to extract.", pos: "noun" },
  "quart": { meaning: "A unit of volume; a quarter of a gallon.", pos: "noun" },
  "quarter": { meaning: "A fourth part; a three-month period; a coin.", pos: "noun" },
  ...
  "quaternary": { meaning: "Fourth in order; consisting of four parts.", pos: "adjective" },
  "quatrain": { meaning: "A stanza of four lines.", pos: "noun" },
  "quaver": { meaning: "To tremble; a musical note; a quavering sound.", pos: "verb" },
  ...
  "questionable": { meaning: "Doubtful; suspicious; uncertain.", pos: "adjective" },
  "queue": { meaning: "A line of people; to line up.", pos: "noun" },
  "quibble": { meaning: "A minor objection; to argue over trivialities.", pos: "noun" },
  ...
  "quintessence": { meaning: "The purest essence; a perfect example.", pos: "noun" },
  "quintuple": { meaning: "Five times as much; to multiply by five.", pos: "adjective" },
  "quintuplet": { meaning: "One of five offspring born at one birth.", pos: "noun" },
  ...
  "quixotic": { meaning: "Excessively romantic; idealistic; impractical.", pos: "adjective" },
